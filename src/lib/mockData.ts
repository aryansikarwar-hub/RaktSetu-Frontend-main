...
export const MOCK_DONORS = [
  ...MOCK_USERS,
  { _id: 'u3', phone: '+91 98111 22334', name: 'Rahul Verma', bloodType: 'O-', city: 'Delhi', donorStatus: 'active', available: true, lastDonation: '2025-11-02', totalDonations: 12, tier: 'Platinum', reliability: 97, verified: true },
  { _id: 'u4', phone: '+91 90000 11223', name: 'Sneha Iyer', bloodType: 'B+', city: 'Mumbai', donorStatus: 'active', available: true, lastDonation: '2026-03-01', totalDonations: 3, tier: 'Silver', reliability: 80, verified: true },
  { _id: 'u5', phone: '+91 93456 77889', name: 'Karthik Nair', bloodType: 'O+', city: 'Chennai', donorStatus: 'active', available: true, lastDonation: '2026-04-10', totalDonations: 5, tier: 'Gold', reliability: 85, verified: true },
  { _id: 'u6', phone: '+91 96789 00112', name: 'Pooja Desai', bloodType: 'O-', city: 'Mumbai', donorStatus: 'active', available: true, lastDonation: '2026-01-05', totalDonations: 8, tier: 'Gold', reliability: 91, verified: true },
  { _id: 'u7', phone: '+91 95678 99001', name: 'Aditya Kumar', bloodType: 'AB-', city: 'Indore', donorStatus: 'active', available: true, lastDonation: '2025-10-20', totalDonations: 9, tier: 'Platinum', reliability: 95, verified: true },
  { _id: 'u8', phone: '+91 94567 88990', name: 'Meera Joshi', bloodType: 'B-', city: 'Pune', donorStatus: 'active', available: false, lastDonation: '2026-05-01', totalDonations: 2, tier: 'Bronze', reliability: 70, verified: true },
];
