...
import { UserPlus, Search, HeartPulse, AlertTriangle, ArrowRight } from 'lucide-react';
...
const ACTIONS = [
  {
    ...
    description: 'Update your donor profile and availability status',
    href: '/user-dashboard',
  ...
  },
  {
    ...
    description: 'Post a critical blood emergency to all nearby donors',
    href: '/emergency-page',
